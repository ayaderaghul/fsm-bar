...
(require "basic.rkt" "configuration.rkt" "utilities.rkt" "population.rkt" "draw.rkt" "inout.rkt")
...
(draw-bundle-f mean-name i rank-name make-automaton-csv-reader DATA-POINT ROUNDS PIE (string-append test-name ".png"))
    ))
